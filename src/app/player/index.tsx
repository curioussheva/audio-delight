...
export default function PlayerScreen() {
  ...
  // Animasi Artwork saat Play/Pause
  useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      {/* BACKGROUND AREA (STATIC GRADIENT) */}
      <LinearGradient
        colors={["#1A2130", "#040B13", "#040B13"]}
        locations={[0, 0.6, 1]}
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerActions}>
            ...
            >
              <Music
                size={22}
                color={showLyrics ? colors.primary[500] : "#FFF"}
                strokeWidth={2.2}
              />
            </TouchableOpacity>
              ...
              >
                ...
                <View
                  style={[
                    ...
                    { backgroundColor: "#1A2130", shadowColor: "#000" },
                  ]}
                />
              </Animated.View>
        ...
        <View style={styles.bottomSection}>
          ...
          <View style={styles.controlsRow}>
            <TouchableOpacity onPress={toggleShuffle}>
              <Shuffle
                size={24}
                color={shuffle ? colors.primary[500] : "rgba(255,255,255,0.4)"}
                strokeWidth={2.5}
              />
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  artworkShadow: {
    ...
    elevation: 20,
    zIndex: -1,
    // filter: "blur(20px)", // Hati-hati, filter blur CSS web kadang tidak jalan sempurna di semua RN platforms, tapi aman dibiarkan jika menggunakan Expo
  },
