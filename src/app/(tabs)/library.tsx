...
export default function LibraryScreen() {
      ...
      Alert.alert(
        ...
        [
          { text: "Batal", style: "cancel" },
          {
            text: "Mulai",
            onPress: async () => {
              await LibraryScanner.scanDirectory(
                targetDir,
                (current, total) => {
  ...
  const processedSongs = useMemo(() => {
    ...
    if (filterBy === "sample-rate-hi-res")
      result = result.filter((s) => (s.sampleRate || 0) > 44100);
      ...
      >
        ...
        >
          <Ionicons
            ...
            size={22}
            color={isNowPlaying ? "#000" : colors.text.tertiary}
          />
        </View>
        ...
        <View style={styles.rightActions}>
          ...
          >
            <Ionicons
              ...
              size={20}
              color={favorite ? colors.status.error : colors.text.tertiary}
            />
          </TouchableOpacity>
      ...
      <View style={styles.tabBar}>
        {(["songs", "playlists", "search"] as const).map((t) => (
          <TouchableOpacity
            ...
            style={[
              styles.tabButton,
              mode === t && { borderBottomColor: colors.primary[500] },
            ]}
          >
            <Text
              style={[
                ...
                {
                  color:
                    mode === t ? colors.primary[500] : colors.text.secondary,
                },
              ]}
            >
              {t.toUpperCase()}
