...
export default function SongDetailScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background.primary }]}>
      ...
      <View style={styles.sectionContainer}>
         ...
         <View style={[styles.card, { backgroundColor: colors.background.secondary }]}>
            <Text style={[styles.cardTitle, { color: colors.text.primary }]}>AUDIO PROPERTIES</Text>
            
            <DetailRow label="Format" value={(song.codec || 'Unknown').toUpperCase()} color={colors} />
            <DetailRow label="Sample Rate" value={song.sampleRate ? `${song.sampleRate / 1000} kHz` : '44.1 kHz'} color={colors} />
            <DetailRow label="Bit Depth" value={song.bitDepth ? `${song.bitDepth}-bit` : '16-bit'} color={colors} />
            <DetailRow label="Bitrate" value={formatBitrate(song.bitrate)} color={colors} />
   ...
   <Text style={[styles.cardTitle, { color: colors.text.primary }]}>SOURCE PATH</Text>
   <Text style={{ color: colors.text.tertiary, fontSize: 11, fontStyle: 'italic' }}>
