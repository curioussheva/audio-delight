          ...
          {(['all', 'title', 'artist', 'album'] as const).map((filter) => (
            <TouchableOpacity
              ...
              style={[styles.filterChip, { 
                ...
                borderRadius: 16,
                backgroundColor: filterBy === filter ? colors.primary[500] : colors.background.secondary,
              }]}
              onPress={() => setFilterBy(filter)}
            >
              <Text style={{ 
                color: filterBy === filter ? colors.background.primary : colors.text.secondary,
                fontSize: 12,
              }}>
        ...
        renderItem={({ item }) => (
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.resultSub, { color: colors.text.secondary }]}>
                {item.artist} • {item.album}
              </Text>
            </View>
            <Text style={[styles.resultDuration, { color: colors.text.tertiary }]}>
