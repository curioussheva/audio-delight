  ...
  if (!currentSong) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.emptySubText}>Informasi bit-depth dan frekuensi akan muncul di sini</Text>
      </View>
    );
  }
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>
          {currentSong.format?.sampleRate && currentSong.format.sampleRate > 48000 
        ...
        <View style={styles.row}>
          <View>
            ...
            <Text style={styles.subValue}>{currentSong.format?.codec || 'FLAC'}</Text>
          </View>
          <View>
          ...
          <View>
            ...
            <Text style={styles.subValue}>{currentSong.format?.sampleRate || 44100} Hz</Text>
          </View>
        </View>
      </View>
      
      {/* Placeholder untuk Spectrum Visualizer Masa Depan */}
      <View style={[styles.card, { height: 200, justifyContent: 'center', borderStyle: 'dashed', borderWidth: 1, borderColor: '#333' }]}>
        <Ionicons name="stats-chart" size={32} color="#222" style={{ alignSelf: 'center', marginBottom: 10 }} />
        <Text style={styles.placeholderText}>Spectrum Analysis Chart Coming Soon</Text>
      </View>
    </ScrollView>
  );
}
