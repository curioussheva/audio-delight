~/.../src/main $ tree -I "cpp/oboe"                     .                                                       ├── AndroidManifest.xml
├── cpp                                                 │   ├── CMakeLists.txt
│   ├── compile_commands.json                           │   ├── core
│   │   ├── AudioBufferController.cpp                   │   │   ├── AudioBufferController.h
│   │   ├── AudioCallback.cpp                           │   │   ├── AudioCallback.h
│   │   ├── AudioConfig.h                               │   │   ├── AudioConstants.h                            │   │   ├── AudioEngine.cpp                             │   │   ├── AudioEngine.h                               │   │   ├── AudioMetrics.cpp                            │   │   ├── AudioMetrics.h                              │   │   ├── AudioModeManager.cpp                        │   │   ├── AudioModeManager.h                          │   │   ├── AudioPipeline.cpp                           │   │   ├── AudioPipeline.h                             │   │   ├── AudioState.h                                │   │   ├── AudioStreamController.cpp                   │   │   ├── AudioStreamController.h                     │   │   ├── AudioTypes.h                                │   │   ├── DSPConfig.h                                 │   │   ├── EngineStats.h                               │   │   └── RingBuffer.h                                │   ├── decoder                                         │   │   ├── AudioDecoder.cpp                            │   │   ├── AudioDecoder.h                              │   │   ├── DecoderFactory.cpp                          │   │   ├── DecoderFactory.h                            │   │   ├── DecoderState.h                              │   │   ├── DecoderTypes.h                              │   │   ├── DecoderUtils.cpp                            │   │   ├── DecoderUtils.h                              │   │   ├── DecoderWorker.cpp                           │   │   ├── DecoderWorker.h
│   │   ├── FFmpegDecoder.cpp                           │   │   ├── FFmpegDecoder.h                             │   │   ├── PCMDecoder.cpp                              │   │   ├── PCMDecoder.h                                │   │   ├── StreamResampler.cpp                         │   │   └── StreamResampler.h
│   ├── devices                                         │   │   ├── AudioDeviceDescriptor.h                     │   │   ├── AudioDeviceManager.cpp                      │   │   ├── AudioDeviceManager.h                        │   │   ├── AudioRouteManager.cpp                       │   │   ├── AudioRouteManager.h                         │   │   ├── DeviceCapabilities.h                        │   │   └── DeviceTypes.h                               │   ├── dsp                                             │   │   ├── BiquadFilter.cpp                            │   │   ├── BiquadFilter.h                              │   │   ├── DCBlocker.h                                 │   │   ├── DSPChain.cpp                                │   │   ├── DSPChain.h                                  │   │   ├── EQProcessor.cpp                             │   │   ├── EQProcessor.h                               │   │   ├── GainProcessor.h                             │   │   ├── Limiter.h                                   │   │   ├── OutputStage.cpp                             │   │   ├── OutputStage.h                               │   │   ├── StereoWidener.h                             │   │   ├── convolution                                 │   │   │   ├── ConvolverNode.cpp                       │   │   │   ├── ConvolverNode.h                         │   │   │   ├── FFTConvolver.cpp                        │   │   │   ├── FFTConvolver.h                          │   │   │   ├── FIRFilter.cpp                           │   │   │   ├── FIRFilter.h                             │   │   │   ├── IRLoader.cpp                            │   │   │   ├── IRLoader.h                              │   │   │   ├── PartitionedConvolver.cpp                │   │   │   ├── PartitionedConvolver.h                  │   │   │   ├── WindowFunctions.cpp                     │   │   │   └── WindowFunctions.h                       │   │   ├── dynamics                                    │   │   │   ├── LimiterNode.cpp                         │   │   │   └── LimiterNode.h                           │   │   ├── filters                                     │   │   │   ├── HighPassFilter.h                        │   │   │   ├── LowPassFilter.h                         │   │   │   ├── StateVariableFilter.cpp                 │   │   │   ├── StateVariableFilter.h                   │   │   │   └── ToneControl.h                           │   │   ├── graph                                       │   │   │   ├── DSPGraph.cpp                            │   │   │   ├── DSPGraph.h                              │   │   │   └── DSPNode.h                               │   │   ├── headphone                                   │   │   │   ├── CrossfeedProcessor.cpp                  │   │   │   ├── CrossfeedProcessor.h                    │   │   │   ├── HeadphoneCorrection.cpp                 │   │   │   └── HeadphoneCorrection.h                   │   │   ├── immersive                                   │   │   │   ├── BinauralRenderer.cpp                    │   │   │   ├── BinauralRenderer.h                      │   │   │   ├── BrainwaveGenerator.cpp                  │   │   │   ├── BrainwaveGenerator.h                    │   │   │   ├── FFTResonanceAnalyzer.cpp                │   │   │   ├── FFTResonanceAnalyzer.h                  │   │   │   ├── HarmonicExciter.cpp                     │   │   │   ├── HarmonicExciter.h                       │   │   │   ├── SolfeggioResonator.cpp                  │   │   │   ├── SolfeggioResonator.h                    │   │   │   ├── SpatialFieldProcessor.cpp               │   │   │   └── SpatialFieldProcessor.h                 │   │   ├── spatial                                     │   │   │   ├── StereoWidenerNode.cpp                   │   │   │   └── StereoWidenerNode.h                     │   │   └── tone                                        │   │       ├── EQNode.cpp                              │   │       ├── EQNode.h                                │   │       ├── GainNode.cpp                            │   │       └── GainNode.h                              │   ├── fft                                             │   │   ├── FFTPlan.cpp                                 │   │   ├── FFTPlan.h                                   │   │   ├── FFTProcessor.cpp                            │   │   ├── FFTProcessor.h                              │   │   ├── FFTypes.h                                   │   │   ├── SpectrumAnalyzer.cpp                        │   │   ├── SpectrumAnalyzer.h                          │   │   ├── SpectrumVisualizer.cpp                      │   │   ├── SpectrumVisualizer.h                        │   │   ├── WaveformVisualizer.cpp                      │   │   └── WaveformVisualizer.h                        │   ├── jni                                             │   │   ├── JSIInstaller.cpp                            │   │   ├── JSIInstaller.h                              │   │   ├── NativeAudioFeed.cpp                         │   │   ├── NativeDSPModule.cpp                         │   │   ├── NativeDeviceModule.cpp                      │   │   ├── NativeDeviceModule.h                        │   │   ├── NativePlaybackModule.cpp                    │   │   ├── NativePlaybackModule.h                      │   │   ├── NativePristineAudio.cpp                     │   │   ├── NativePristineAudio.h                       │   │   ├── NativeVisualizerModule.cpp                  │   │   └── Onload.cpp                                  │   ├── manager                                         │   │   ├── EngineManager.cpp                           │   │   └── EngineManager.h                             │   ├── modes                                           │   │   ├── BitPerfectPipeline.cpp                      │   │   ├── BitPerfectPipeline.h                        │   │   ├── DSPPipeline.cpp                             │   │   ├── DSPPipeline.h                               │   │   ├── ImmersivePipeline.cpp                       │   │   └── ImmersivePipeline.h                         │   ├── playback                                        │   │   ├── DecodedAudioQueue.cpp                       │   │   ├── DecodedAudioQueue.h                         │   │   ├── FadeEngine.cpp                              │   │   ├── FadeEngine.h                                │   │   ├── PCMQueue.cpp                                │   │   ├── PCMQueue.h                                  │   │   ├── PlaybackClock.cpp                           │   │   ├── PlaybackClock.h                             │   │   ├── PlaybackController.cpp                      │   │   ├── PlaybackController.h                        │   │   ├── PlaybackEvents.h                            │   │   ├── PlaybackManager.cpp                         │   │   ├── PlaybackManager.h                           │   │   ├── PlaybackMetrics.h                           │   │   ├── PlaybackScheduler.cpp                       │   │   ├── PlaybackScheduler.h                         │   │   ├── PlaybackState.h                             │   │   ├── PlaybackTypes.h                             │   │   ├── PrebufferManager.cpp                        │   │   ├── PrebufferManager.h                          │   │   ├── SchedulerTypes.h                            │   │   ├── TrackQueue.cpp                              │   │   ├── TrackQueue.h                                │   │   └── TransportState.h                            │   ├── profiling                                       │   │   ├── CPUProfiler.cpp                             │   │   ├── CPUProfiler.h                               │   │   ├── DSPBenchmark.cpp                            │   │   ├── DSPBenchmark.h                              │   │   ├── LatencyProfiler.cpp                         │   │   └── LatencyProfiler.h                           │   ├── realtime                                        │   │   ├── CallbackTimer.cpp                           │   │   ├── CallbackTimer.h                             │   │   ├── RealtimeThread.h                            │   │   └── ThreadPriority.h                            │   ├── resampler                                       │   │   ├── AudioResampler.cpp                          │   │   ├── AudioResampler.h                            │   │   ├── LinearResampler.cpp                         │   │   ├── LinearResampler.h                           │   │   ├── ResamplerTypes.h                            │   │   ├── SRCQuality.h                                │   │   ├── SincResampler.cpp                           │   │   └── SincResampler.h                             │   ├── session                                         │   │   ├── AudioFocusManager.cpp                       │   │   ├── AudioFocusManager.h                         │   │   ├── AudioSessionManager.cpp                     │   │   ├── AudioSessionManager.h                       │   │   ├── NoisyReceiverHandler.cpp                    │   │   ├── NoisyReceiverHandler.h                      │   │   ├── TransportControls.cpp                       │   │   └── TransportControls.h                         │   ├── usb                                             │   │   ├── USBClockSync.cpp                            │   │   ├── USBClockSync.h                              │   │   ├── USBDACCapabilities.cpp                      │   │   ├── USBDACCapabilities.h                        │   │   ├── USBDeviceManager.cpp                        │   │   ├── USBDeviceManager.h                          │   │   ├── USBStreamSession.cpp                        │   │   └── USBStreamSession.h                          │   ├── utils                                           │   │   ├── AlignedBuffer.h                             │   │   ├── AudioMath.h                                 │   │   ├── DenormalFix.h                               │   │   ├── Logger.h                                    │   │   ├── SIMD.h                                      │   │   └── ScopedTrace.h                               │   └── visualizer                                      │       ├── VisualizerBuffer.cpp                        │       └── VisualizerBuffer.h                          ├── java                                                │   └── com                                             │       └── pristineaudio                               │           ├── app                                     │           │   ├── MainActivity.kt                     │           │   └── MainApplication.kt                  │           ├── audio                                   │           ├── dsp                                     │           │   ├── DSPController.kt                    │           │   └── NativeDSPModule.kt                  │           ├── media                                   │           │   └── MediaStoreModule.kt                 │           ├── usb                                     │           │   ├── USBDACModule.kt                     │           │   └── USBDACPackage.kt                    │           └── visualizer                              │               └── NativeVisualizerBridge.kt           └── res                                                     ├── drawable                                            │   ├── ic_launcher_background.xml                      │   └── rn_edit_text_material.xml                       ├── drawable-hdpi                                       │   └── splashscreen_logo.png                           ├── drawable-mdpi                                       │   └── splashscreen_logo.png                           ├── drawable-night-hdpi                                 │   └── splashscreen_logo.png                           ├── drawable-night-mdpi                                 │   └── splashscreen_logo.png                           ├── drawable-night-xhdpi                                │   └── splashscreen_logo.png                           ├── drawable-night-xxhdpi                               │   └── splashscreen_logo.png                           ├── drawable-night-xxxhdpi                              │   └── splashscreen_logo.png                           ├── drawable-xhdpi                                      │   └── splashscreen_logo.png                           ├── drawable-xxhdpi                                     │   └── splashscreen_logo.png                           ├── drawable-xxxhdpi                                    │   └── splashscreen_logo.png                           ├── mipmap-anydpi-v26                                   │   ├── ic_launcher.xml                                 │   └── ic_launcher_round.xml                           ├── mipmap-hdpi                                         │   ├── ic_launcher.webp                                │   ├── ic_launcher_foreground.webp                     │   └── ic_launcher_round.webp                          ├── mipmap-mdpi                                         │   ├── ic_launcher.webp                                │   ├── ic_launcher_foreground.webp                     │   └── ic_launcher_round.webp                          ├── mipmap-xhdpi                                        │   ├── ic_launcher.webp                                │   ├── ic_launcher_foreground.webp                     │   └── ic_launcher_round.webp                          ├── mipmap-xxhdpi                                       │   ├── ic_launcher.webp                                │   ├── ic_launcher_foreground.webp                     │   └── ic_launcher_round.webp                          ├── mipmap-xxxhdpi                                      │   ├── ic_launcher.webp                                │   ├── ic_launcher_foreground.webp                     │   └── ic_launcher_round.webp                          ├── values                                              │   ├── colors.xml                                      │   ├── strings.xml                                     │   └── styles.xml                                      ├── values-night                                        │   └── colors.xml                                      └── xml                                                     └── device_filter.xml                                                                                   56 directories, 242 files                               ~/.../src/main $
...
### Validasi CI kedua — konfirmasi fix FFmpeg berhasil, temuan baru JSI (22 Agustus 2026)

Setelah commit migrasi namespace + fix FFmpeg (`CMakeLists.txt`) di-push, CI dijalankan ulang. Hasil:

- **Fix FFmpeg tervalidasi 100%**: pesan custom `"FFmpeg not found, decoder will use PCM only -- excluding decoder/FFmpegDecoder.cpp from build"` muncul persis di log CMake configure, dan `FFmpegDecoder.cpp.o` **tidak ada** di daftar file yang dikompail sama sekali. Build lanjut sampai **55/143 file** (jauh melampaui titik gagal sebelumnya di file #27/144).
- **Validasi tambahan**: seluruh file yang disentuh migrasi namespace sesi ini — `BiquadFilter.cpp`, `devices/AudioDeviceManager.cpp`, `devices/AudioRouteManager.cpp`, `EQProcessor.cpp`, `DSPChain.cpp`, semua `dsp/immersive/*` (5 file), semua `fft/*` yang tereksekusi build order (`FFTPlan`, `FFTProcessor`, `SpectrumAnalyzer`, `WaveformVisualizer`, `SpectrumVisualizer`), `session/TransportControls.cpp`, `jni/NativeDeviceModule.cpp`, `jni/NativeDSPModule.cpp`, `jni/NativeAudioFeed.cpp` — **semuanya sukses dikompail** di toolchain CI asli.
- **Kegagalan baru ditemukan**: `jni/JSIInstaller.cpp` — `'jsi/jsi.h' file not found`. Dugaan sebelumnya (bahwa ini "limitation lingkungan Termux, kemungkinan besar sudah bersih di CI") **ternyata salah** — ini genuinely masalah konfigurasi project. Terlihat dari compile command lengkap di log: daftar `-I` include path untuk target `pristine-audio` **sama sekali tidak menyertakan** path ke JSI headers, padahal target lain di project yang sama (Skia) berhasil menemukan `-- JSI : ReactAndroid::jsi` di log configure sebelumnya. Petunjuk kunci: CMake warning `"Manually-specified variables were not used by the project: PROJECT_BUILD_DIR PROJECT_ROOT_DIR REACT_ANDROID_DIR"` — Gradle **sudah** mengirim `REACT_ANDROID_DIR` ke CMake, tapi `CMakeLists.txt` project ini tidak pernah memakainya sama sekali.

---

### Fix `CMakeLists.txt` — link `ReactAndroid::jsi` (22 Agustus 2026)

**Fix**: ditambahkan `find_package(ReactAndroid CONFIG REQUIRED)` sebelum `add_library(pristine-audio ...)`, dan `ReactAndroid::jsi` ke section `PRIVATE` di `target_link_libraries(pristine-audio ...)` yang sudah ada. Pendekatan ini meniru pola yang sudah terbukti bekerja untuk target Skia di project yang sama (dikonfirmasi via log CI sebelumnya yang menunjukkan `-- JSI : ReactAndroid::jsi` berhasil ditemukan untuk target itu) — bukan menebak syntax dari nol.

**Catatan proses**: insert dilakukan berbasis nomor baris pasti (`grep -n`/`cat -n` untuk konfirmasi posisi sebelum tiap `sed`), konsisten dengan pola yang sudah terbukti reliable sejak insiden `TrackQueue.cpp`/`PlaybackManager.cpp` sebelumnya. Fix ini **tidak bisa diverifikasi lokal** (CMake config-level, bukan level `clangd`/C++ compile-check) — verifikasi murni menunggu hasil CI berikutnya.

**Hasil — tervalidasi CI ketiga**: build push berikutnya menunjukkan:
- **Tidak ada lagi** error `jsi/jsi.h` file not found di manapun dalam log.
- **Tidak ada** `BUILD FAILED` sama sekali — log berakhir normal dengan notice deprecation Gradle standar (ciri build sukses), bukan diakhiri `* What went wrong:` seperti 2 log CI sebelumnya.
- Sisa yang muncul di log CI hanyalah **warning kosmetik**, tidak ada satupun `error:`/`fatal error:`/`FAILED:`:
  - `fft/FFTPlan.h:18` — private field `mCfg` tidak terpakai
  - `fft/SpectrumAnalyzer.h:16` — private field `mSampleRate` tidak terpakai
  - `fft/SpectrumVisualizer.cpp` / `fft/WaveformVisualizer.cpp` — `Impl` dideklarasikan `class` di header, didefinisikan `struct` di `.cpp` (valid, tidak masalah untuk Android/NDK ABI)
  - `fft/WaveformVisualizer.cpp:10` — urutan inisialisasi member constructor `Impl` tidak sesuai urutan deklarasi (`-Wreorder-ctor`)
  - `playback/PlaybackState.h:59,63` — move constructor/assignment implicitly deleted karena field `atomic<PlaybackStatus>` — pre-existing, tidak terkait pekerjaan sesi ini

**Keputusan**: warning kosmetik di atas sengaja **tidak dibersihkan** pada sesi ini — fokus proyek bergeser ke area UI/JS. Dicatat di `build-fix-status.md` untuk referensi kalau nanti mau dituntaskan.

---

## STATUS FINAL

Build native C++ (`pristine-audio`) **selesai dan tervalidasi CI penuh** — tidak ada lagi `BUILD FAILED`, tidak ada `error:`/`fatal error:` di log build manapun. Seluruh 82 file `.cpp` compile bersih di toolchain NDK asli (dengan `FFmpegDecoder.cpp` dikecualikan otomatis dari build sesuai desain saat FFmpeg tidak tersedia — bukan kegagalan). Tersisa hanya 5 warning kosmetik non-blocking yang sengaja ditunda karena fokus proyek berpindah ke area UI/JS.
